...
printf "${B}  ╔══════════════════════════════════════════════════════════╗${R}\n"
printf "${B}  ║${R}                                                          ${B}║${R}\n"
printf "${B}  ║${R}  ${B}██████${R} ${M}██████${R} ${M}██████${R} ${M}███████${R} ${P}███████${R} ${P}██████${R} ${P}██${R} ${P}██████${R}  ${B}║${R}\n"
printf "${B}  ║${R}  ${B}██  ██${R} ${M}██  ██${R} ${M}██  ██${R} ${M}██     ${R} ${P}   ██   ${R} ${P}██████${R} ${P}██${R} ${P}██  ██${R}  ${B}║${R}\n"
printf "${B}  ║${R}  ${B}██████${R} ${M}██  ██${R} ${M}██  ██${R} ${M}███████${R} ${P}   ██   ${R} ${P}██  ██${R} ${P}██${R} ${P}██  ██${R}  ${B}║${R}\n"
printf "${B}  ║${R}  ${B}██  ██${R} ${M}██  ██${R} ${M}██  ██${R} ${M}     ██${R} ${P}   ██   ${R} ${P}██████${R} ${P}██${R} ${P}██████${R}  ${B}║${R}\n"
printf "${B}  ║${R}                                                          ${B}║${R}\n"
printf "${B}  ║${R}         ☁   ${M}☁${R}     ${M}☁   ☁${R}       ${P}☁${R}     ${P}☁   ☁${R}           ${B}║${R}\n"
printf "${B}  ║${R}                                                          ${B}║${R}\n"
printf "${B}  ║${R}    ${W}${BOLD}B O O S T E R O I D${R}   ${DIM}(unofficial)${R}                  ${B}║${R}\n"
printf "${B}  ║${R}    ${P}Steam Deck Flatpak Installer${R}                          ${B}║${R}\n"
printf "${B}  ║${R}                                                          ${B}║${R}\n"
printf "${P}  ╚══════════════════════════════════════════════════════════╝${R}\n"
printf "\n"
